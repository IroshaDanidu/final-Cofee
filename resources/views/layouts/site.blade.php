                                            ...
                                            <x-dropdown align="right" width="48">
                                                ...
                                                <x-slot name="content">
                                                    ...
                                                    @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                                        <x-dropdown-link href="{{ route('api-tokens.index.blade.php') }}">
                                                            {{ __('API Tokens') }}
                                                        </x-dropdown-link>
                                                    @endif
                                    ...
                                    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
                                        ...
                                        <div class="pt-4 pb-1 border-t border-gray-200">
                                            ...
                                            <div class="mt-3 space-y-1">
                                                ...
                                                @if (Laravel\Jetstream\Jetstream::hasApiFeatures())
                                                    <x-responsive-nav-link href="{{ route('api-tokens.index.blade.php') }}"
                                                                           :active="request()->routeIs('api-tokens.index.blade.php')">
                                                        {{ __('API Tokens') }}
                                                    </x-responsive-nav-link>
                                                @endif
